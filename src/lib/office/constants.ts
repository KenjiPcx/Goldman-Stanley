...
export const HALF_FLOOR = FLOOR_SIZE / 2;
export const WALL_THICKNESS = 0.2;
export const WALL_HEIGHT = 2.5;
export const FLOOR_SIZE_FOR_DECOR = FLOOR_SIZE;

// --- Desk + furniture dimensions ---
export const DESK_WIDTH = 2;
export const DESK_DEPTH = 1;
export const DESK_HEIGHT = 0.5;
export const COMPUTER_HEIGHT = 0.4;
export const DESK_SPACING = 4;
...
// --- Idle destinations for wandering employees ---
...
// --- Decorative object positions (hard coded for now) ---
